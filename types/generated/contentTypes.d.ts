...
export interface ApiCompanyAddressCompanyAddress extends Schema.SingleType {
  collectionName: 'company_addresses';
  info: {
    singularName: 'company-address';
    pluralName: 'company-addresses';
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::company-address.company-address',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomeBodyTextHomeBodyText extends Schema.SingleType {
  collectionName: 'home_body_texts';
  info: {
    singularName: 'home-body-text';
    pluralName: 'home-body-texts';
    displayName: 'Home-body-Text';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    BodyText: Attribute.Blocks & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::home-body-text.home-body-text',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::company-address.company-address': ApiCompanyAddressCompanyAddress;
      'api::home-banner.home-banner': ApiHomeBannerHomeBanner;
      'api::home-body-text.home-body-text': ApiHomeBodyTextHomeBodyText;
